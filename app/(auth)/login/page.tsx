      ...
      <div className="glass-card rounded-2xl p-8">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center">
            <svg className="w-8 h-8 text-stone-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Button
          ...
          disabled={isLoading}
          className="w-full h-12 bg-white hover:bg-gray-50 text-gray-800 font-medium border border-gray-300 shadow-sm"
        >
          {isLoading ? (
    ...
    <Suspense fallback={
      <div className="w-full max-w-md">
        <div className="glass-card rounded-2xl p-8 animate-pulse">
          <div className="w-16 h-16 bg-stone-700 rounded-2xl mx-auto mb-4" />
          <div className="h-8 bg-stone-700 rounded mb-4 w-3/4 mx-auto" />
          <div className="h-4 bg-stone-700 rounded mb-8 w-1/2 mx-auto" />
