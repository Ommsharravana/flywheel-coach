...
export default function EventContentGeneratorPage() {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem(`demo-day-templates-${slug}`);
    if (saved) {
  ...
  const handleSaveTemplate = () => {
    ...
    localStorage.setItem(`demo-day-templates-${slug}`, JSON.stringify(updated));
    setTemplateName('');
