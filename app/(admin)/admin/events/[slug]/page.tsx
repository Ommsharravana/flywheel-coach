...
export default async function EventAdminPage({ params }: EventAdminPageProps) {
  ...
  try {
    ...
    console.error('[EventAdminPage] builderCount error:', err);
  }
  ...
  try {
    ...
    console.error('[EventAdminPage] totalCycles error:', err);
  }
  ...
  try {
    ...
    console.error('[EventAdminPage] completedCycles error:', err);
  }
  ...
  try {
    ...
    console.error('[EventAdminPage] problemCount error:', err);
  }
  ...
  try {
    ...
    console.error('[EventAdminPage] submissionCount error:', err);
  }
